<?php
/*
Plugin Name: Inbox First
Plugin URI: https://tylerjohnsondesign.com
Description: Connect and integrate with Inbox First.
Version: 2.1.0
Author: Tyler Johnson
Author URI: https://tylerjohnsondesign.com
Copyright: Tyler Johnson Design
Text Domain: inboxfirst
...
Constants
**/
define('IFKLICKED_BASE_VERSION', '2.0.9');
...
$ifUpdates = Puc_v4_Factory::buildUpdateChecker(
	'https://github.com/tylerjohnsondesign/inbox-first',
	__FILE__,
	'inbox-first'
);
$ifUpdates->getVcsApi()->enableReleaseAssets();
...
**/
function ifklicked_is_plugin_active( $plugin ) {
