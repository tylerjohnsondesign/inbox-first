...
class klickedIFSchedule {
	...
	public function ifklicked_schedule_page_init() {
        ...
        foreach($schedules as $schedule) {
			...
			// Custom URL
            add_settings_field(
                'customurl_schedule_'.$schedule,
                'Custom URL',
                array($this, 'customurl_schedule_'.$schedule.'_callback'),
                'inbox-first-schedule',
                'ifklicked_schedule_'.$schedule.'_section'
            );
	...
	public function ifklicked_schedule_sanitize($input) {
        ...
        foreach($schedules as $schedule) {
			...
			if(isset($input['customurl_schedule_'.$schedule])) {
                $sanitary_values['customurl_schedule_'.$schedule] = sanitize_text_field($input['customurl_schedule_'.$schedule]);
            }
	...
	public function customurl_schedule_one_callback() {
        printf(
			'<input class="regular-text" type="text" name="ifklicked_schedule_option_name[customurl_schedule_one]" id="ifklicked_template_schedule_four" value="%s">',
			isset( $this->ifklicked_schedule_options['customurl_schedule_one'] ) ? esc_attr( $this->ifklicked_schedule_options['customurl_schedule_one']) : ''
		);
    }

	public function customurl_schedule_two_callback() {
        printf(
			'<input class="regular-text" type="text" name="ifklicked_schedule_option_name[customurl_schedule_two]" id="ifklicked_template_schedule_four" value="%s">',
			isset( $this->ifklicked_schedule_options['customurl_schedule_two'] ) ? esc_attr( $this->ifklicked_schedule_options['customurl_schedule_two']) : ''
		);
    }

	public function customurl_schedule_three_callback() {
        printf(
			'<input class="regular-text" type="text" name="ifklicked_schedule_option_name[customurl_schedule_three]" id="ifklicked_template_schedule_four" value="%s">',
			isset( $this->ifklicked_schedule_options['customurl_schedule_three'] ) ? esc_attr( $this->ifklicked_schedule_options['customurl_schedule_three']) : ''
		);
    }

	public function customurl_schedule_four_callback() {
        printf(
			'<input class="regular-text" type="text" name="ifklicked_schedule_option_name[customurl_schedule_four]" id="ifklicked_template_schedule_four" value="%s">',
			isset( $this->ifklicked_schedule_options['customurl_schedule_four'] ) ? esc_attr( $this->ifklicked_schedule_options['customurl_schedule_four']) : ''
		);
    }
